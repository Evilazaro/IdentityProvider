...
| ---------------------------- | ---------------- | -------------- | ---------------------------------------------- |
| Secure Identity Management   | ✅ Implemented   | 3 — Defined    | ASP.NET Core Identity with cookie auth         |
| Application Onboarding       | ⚠️ Partial       | 2 — Managed    | UI present; persistence not implemented        |
| Multi-Factor Authentication  | ✅ Implemented   | 3 — Defined    | TOTP via authenticator app, recovery codes     |
| External Identity Federation | ⚠️ Scaffolded    | 2 — Managed    | Framework in place; no providers configured    |
| Account Self-Service         | ✅ Implemented   | 3 — Defined    | Password, email, 2FA, personal data management |
| Email-Based Security         | ⚠️ Stub          | 2 — Managed    | No-Op sender; email confirmation flow present  |
| Observability                | ✅ Implemented   | 3 — Defined    | Azure Application Insights connected           |
| Container-Native Deployment  | ✅ Implemented   | 3 — Defined    | Azure Container App via `azure.yaml` and Bicep |
...
| Component                             | Description                                                                                                            | Domain        | Owner                | Maturity    | Dependencies                                       | Triggers                               | Source File     |
| ------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- | ------------- | -------------------- | ----------- | -------------------------------------------------- | -------------------------------------- | --------------- |
| Identity & Access Management Platform | Self-hosted IAM service providing centralized user authentication, account management, and OAuth/OIDC app registration | Cross-cutting | Platform Engineering | 3 — Defined | Azure Container App, SQLite, ASP.NET Core Identity | Business need for centralized identity | azure.yaml:1-14 |
...
| Component                           | Description                                                                                                                            | Domain              | Owner                | Maturity    | Dependencies                                                       | Triggers                                        | Source File                                                                             |
| ----------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- | ------------------- | -------------------- | ----------- | ------------------------------------------------------------------ | ----------------------------------------------- | --------------------------------------------------------------------------------------- |
| User Identity Management            | Create, store, and lifecycle-manage user identities; includes registration, credential management, and account confirmation            | Identity Domain     | Identity Team        | 3 — Defined | ApplicationUser, ApplicationDbContext, Identity Service            | User registration request                       | src/IdentityProvider/Data/ApplicationUser.cs:1-9                                        |
| Application Registration Management | Onboard OAuth/OIDC client applications by capturing and validating client credentials; persistence not yet implemented                 | Application Domain  | Platform Engineering | 2 — Managed | AppRegistration entity, AppRegistrationForm                        | Developer submission                            | src/IdentityProvider/Components/AppRegistration.cs:1-45                                 |
| Multi-Factor Authentication         | Enforce TOTP-based second authentication factor with authenticator app setup, code verification, and recovery code lifecycle           | Identity Domain     | Identity Team        | 3 — Defined | TOTP, UserManager, Identity cookie                                 | User 2FA enrolment                              | src/IdentityProvider/Components/Account/Pages/Manage/TwoFactorAuthentication.razor:1-85 |
| External Identity Federation        | Accept authentication from external OAuth/OIDC providers; associate external claims with local ApplicationUser accounts                | Identity Domain     | Identity Team        | 2 — Managed | SignInManager, ExternalLogin page, external provider configuration | External provider callback                      | src/IdentityProvider/Components/Account/Pages/ExternalLogin.razor:1-100                 |
| Account Self-Service                | Enable authenticated users to independently manage all profile attributes: email, password, phone, external logins, 2FA, personal data | Self-Service Domain | Identity Team        | 3 — Defined | UserManager, SignInManager, all Manage/\* pages                    | User-initiated account action                   | src/IdentityProvider/Components/Account/Pages/Manage/Index.razor:\*                     |
| Email Verification & Notification   | Send transactional emails for account confirmation, password reset, email change, and 2FA notifications                                | Identity Domain     | Platform Engineering | 2 — Managed | IEmailSender, IdentityNoOpEmailSender                              | User registration, password reset, email change | src/IdentityProvider/Components/Account/IdentityNoOpEmailSender.cs:\*                   |
...
| Component                     | Description                                                                                                              | Domain             | Owner                | Maturity    | Steps                                                             | Source File                                                           |
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------ | ------------------ | -------------------- | ----------- | ----------------------------------------------------------------- | --------------------------------------------------------------------- |
| User Onboarding Stream        | New user progresses from registration form submission through email confirmation to first authenticated session          | Identity Domain    | Identity Team        | 3 — Defined | Register → EmailConfirmationSent → EmailConfirmed → Login         | src/IdentityProvider/Components/Account/Pages/Register.razor:1-70     |
| Secure Authentication Stream  | Returning user credential validation progressing through optional TOTP MFA check to session cookie issuance              | Identity Domain    | Identity Team        | 3 — Defined | EnterCredentials → ValidatePassword → (MFA?) → SessionEstablished | src/IdentityProvider/Components/Account/Pages/Login.razor:1-80        |
| Application Onboarding Stream | Developer submits app registration form; system validates fields; credentials are issued (persistence currently stubbed) | Application Domain | Platform Engineering | 2 — Managed | SubmitForm → ValidateFields → IssueCredentials                    | src/IdentityProvider/Components/Pages/AppRegistrationForm.razor:1-100 |
...
| Component                          | Description                                                                                                                                       | Domain              | Owner                | Maturity    | Input                             | Output                                         | Source File                                                                |
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------- | -------------------- | ----------- | --------------------------------- | ---------------------------------------------- | -------------------------------------------------------------------------- |
| User Registration Process          | User submits email and password; system hashes password, stores ApplicationUser, sends confirmation email; user redirected to confirmation notice | Identity Domain     | Identity Team        | 3 — Defined | Email, Password, ConfirmPassword  | Pending ApplicationUser, EmailConfirmationSent | src/IdentityProvider/Components/Account/Pages/Register.razor:55-90         |
| Local Authentication Process       | User submits email and password; SignInManager validates credentials; session cookie issued; user redirected to return URL                        | Identity Domain     | Identity Team        | 3 — Defined | Email, Password, RememberMe       | Session cookie or AuthFailed                   | src/IdentityProvider/Components/Account/Pages/Login.razor:60-100           |
| External Authentication Process    | User selects external provider; browser redirects to provider; provider returns assertion; local account associated or created                    | Identity Domain     | Identity Team        | 2 — Managed | External provider selection       | Associated ApplicationUser + session           | src/IdentityProvider/Components/Account/Pages/ExternalLogin.razor:60-130   |
| Two-Factor Authentication Process  | Enrolled user enters TOTP code after password validation; system verifies code; session elevated to 2FA-authenticated state                       | Identity Domain     | Identity Team        | 3 — Defined | TOTP code or Recovery code        | 2FA-elevated session or AuthFailed             | src/IdentityProvider/Components/Account/Pages/LoginWith2fa.razor:\*        |
| Password Reset Process             | User requests reset; reset email dispatched; user follows link; new password submitted; hash stored; session invalidated                          | Identity Domain     | Identity Team        | 3 — Defined | Email address                     | Updated password hash                          | src/IdentityProvider/Components/Account/Pages/ForgotPassword.razor:\*      |
| App Registration Creation Process  | Developer fills app registration form; form validates data annotations; HandleValidSubmit called (currently stub)                                 | Application Domain  | Platform Engineering | 2 — Managed | AppRegistration form fields       | (Stubbed) App credentials                      | src/IdentityProvider/Components/Pages/AppRegistrationForm.razor:80-100     |
| Account Profile Management Process | Authenticated user navigates Manage portal; updates email, phone, password, or external logins; changes persisted via UserManager                 | Self-Service Domain | Identity Team        | 3 — Defined | Updated profile attribute values  | Updated ApplicationUser record                 | src/IdentityProvider/Components/Account/Pages/Manage/Index.razor:\*        |
| Personal Data Management Process   | Authenticated user downloads personal data JSON or initiates account deletion with mandatory password confirmation                                | Self-Service Domain | Identity Team        | 3 — Defined | User request (download or delete) | JSON file or account deletion                  | src/IdentityProvider/Components/Account/Pages/Manage/PersonalData.razor:\* |
...
| Component                | Description                                                                                            | Domain             | Owner                | Maturity    | Interface / Implementation                                  | Dependencies                                      | Source File                                                            |
| ------------------------ | ------------------------------------------------------------------------------------------------------ | ------------------ | -------------------- | ----------- | ----------------------------------------------------------- | ------------------------------------------------- | ---------------------------------------------------------------------- |
| Identity Service         | Core ASP.NET Core Identity providing user CRUD, claims management, and role management                 | Identity Domain    | Identity Team        | 3 — Defined | `IdentityCore<ApplicationUser>`                             | ApplicationDbContext, EF Core                     | src/IdentityProvider/Program.cs:27-34                                  |
| Sign-In Manager Service  | Manages authentication state: cookie sign-in/out, external challenge, lockout, 2FA elevation           | Identity Domain    | Identity Team        | 3 — Defined | `SignInManager<ApplicationUser>`                            | Identity Service, HTTP context                    | src/IdentityProvider/Program.cs:15-24                                  |
| User Manager Service     | Provides CRUD on ApplicationUser: create, password hash, token generation, email confirmation, 2FA     | Identity Domain    | Identity Team        | 3 — Defined | `UserManager<ApplicationUser>`                              | ApplicationDbContext, DataProtectionTokenProvider | src/IdentityProvider/Program.cs:27-34                                  |
| Email Sender Service     | Dispatches transactional emails for account confirmation, password reset, and change notifications     | Identity Domain    | Platform Engineering | 2 — Managed | `IEmailSender<ApplicationUser>` → `IdentityNoOpEmailSender` | (None — stub)                                     | src/IdentityProvider/Components/Account/IdentityNoOpEmailSender.cs:\*  |
| App Registration Service | Accepts and validates new OAuth/OIDC application registration submissions; persistence not implemented | Application Domain | Platform Engineering | 2 — Managed | `AppRegistrationForm` Blazor component                      | AppRegistration entity (unstored)                 | src/IdentityProvider/Components/Pages/AppRegistrationForm.razor:80-100 |
| Email Validation Service | Validates email format and domain membership before accepting registration inputs                      | Identity Domain    | Identity Team        | 2 — Managed | `eMail.checkEmail()`                                        | Hardcoded domain list                             | src/IdentityProvider/Components/eMail.cs:1-18                          |
...
| Component                       | Description                                                                                                                      | Domain              | Owner                | Maturity    | Invoked By                                                                   | Output                           | Source File                                                                                        |
| ------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | ------------------- | -------------------- | ----------- | ---------------------------------------------------------------------------- | -------------------------------- | -------------------------------------------------------------------------------------------------- |
| Account Authentication          | Validate email/password credentials via SignInManager and issue identity cookie on success                                       | Identity Domain     | Identity Team        | 3 — Defined | Login.razor, PerformExternalLogin endpoint                                   | Session cookie or error          | src/IdentityProvider/Components/Account/Pages/Login.razor:60-100                                   |
| Session Management              | Create, maintain, validate, and terminate identity session cookies; supports persistent (Remember Me) and session-scoped cookies | Identity Domain     | Identity Team        | 3 — Defined | IdentityRevalidatingAuthStateProvider, Logout endpoint                       | Cookie lifecycle managed         | src/IdentityProvider/Components/Account/IdentityRevalidatingAuthenticationStateProvider.cs:\*      |
| Application Credential Issuance | Record OAuth/OIDC client credentials in the AppRegistrations table (currently stubbed — form submitted but not saved)            | Application Domain  | Platform Engineering | 2 — Managed | AppRegistrationForm.HandleValidSubmit                                        | AppRegistration record (pending) | src/IdentityProvider/Components/Pages/AppRegistrationForm.razor:88-98                              |
| User Profile Management         | Enable authenticated users to update email address, phone number, password, and linked external logins via the Manage portal     | Self-Service Domain | Identity Team        | 3 — Defined | Manage/\*.razor pages                                                        | Updated ApplicationUser          | src/IdentityProvider/Components/Account/Pages/Manage/Index.razor:\*                                |
| Security Code Generation        | Generate and validate TOTP verification codes, recovery codes, email confirmation tokens, and password reset tokens              | Identity Domain     | Identity Team        | 3 — Defined | EnableAuthenticator.razor, GenerateRecoveryCodes.razor, ForgotPassword.razor | Time-limited tokens and codes    | src/IdentityProvider/Components/Account/Pages/Manage/EnableAuthenticator.razor:\*                  |
| Personal Data Export            | Compile all PersonalData-attributed properties of ApplicationUser into a downloadable JSON document                              | Self-Service Domain | Identity Team        | 3 — Defined | DownloadPersonalData endpoint                                                | JSON file download               | src/IdentityProvider/Components/Account/IdentityComponentsEndpointRouteBuilderExtensions.cs:70-110 |
